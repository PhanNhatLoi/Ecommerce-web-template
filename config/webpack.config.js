  ...
  return {
    ...
    optimization: {
      ...
      minimizer: [
        ...
        // new TerserPlugin({
        //   terserOptions: {
        //     open if need remove all console
        //     compress: {
        //       drop_console: true,
        //     },
        //     mangle: true
    ...
    plugins: [
      // Log progress during compile process
      new webpack.ProgressPlugin({
        ...
        handler(percentage, message, ...args) {
          ...
          console.info(`\x1b[33m${Math.round(percentage * 100)}%\x1b[0m`, '~', message, ...args);
        },
        modules: true,
        modulesCount: 5000,
        profile: true,
