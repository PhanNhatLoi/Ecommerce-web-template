...
export const getRequests = (params) =>
  apiAction('get')(types.GET_REQUESTS, `/services/request/api/v1/vendor/members/problems/list${parseObjToQuery(params)}`, {}, true);
...
export const getProblemCategories = (params) =>
  apiAction('get')(types.GET_PROBLEM_CATEGORIES, `/services/catalog/api/v1/vendor/catalogs${parseObjToQuery(params)}`, {}, true);
export const getRequesters = (params) =>
  apiAction('get')(types.GET_REQUESTERS, `/services/profile/api/v1/vendor/members/consumer/approved${parseObjToQuery(params)}`, {}, true);
export const getRequesterVehicles = (params) =>
  apiAction('get')(
    types.GET_REQUESTER_VEHICLES,
    `/services/profile/api/v1/vendor/customer-vendors/vehicle-infos/${params.memberId}${parseObjToQuery(params)}`,
    {},
    true
  );
// -----------------------------
...
export const getRequestStatistic = (params) =>
  apiAction('get')(
    ...
    `/services/request/api/v1/vendor/members/problems/list/statistic${parseObjToQuery(params)}`,
    {},
    true
  );
// -----------------------------
