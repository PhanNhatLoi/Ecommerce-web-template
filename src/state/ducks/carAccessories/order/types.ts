...
export const CREATE_SALE_ORDER = 'orders/CREATE_SALE_ORDER';
export const UPDATE_SALE_ORDER = 'orders/UPDATE_ORDER';
export const UPDATE_STATUS_SALE_ORDER = 'orders/UPDATE_STATUS_ORDER';
...
export const DELETE_SALE_ORDER = 'orders/DELETE_ORDER';
