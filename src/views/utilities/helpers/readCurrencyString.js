...
function readCurrencyString(numCurrency) {
  let count = 0;
  let num = 0;
  let result = '';
  let position = [];
  ...
  position[5] = ~~(num / 1000000000000);
  if (isNaN(position[5])) position[5] = '0';
  num = num - parseFloat(position[5].toString()) * 1000000000000;
  position[4] = ~~(num / 1000000000);
  if (isNaN(position[4])) position[4] = '0';
  num = num - parseFloat(position[4].toString()) * 1000000000;
...
export default readCurrencyString;
