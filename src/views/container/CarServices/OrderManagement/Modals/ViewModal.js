...
const ViewModal = (props) => {
  ...
  return (
    <AntModal
      title={isEditing ? `${t('order_edit')}` : t('order_detail')}
      description={isEditing ? t('order_edit_des') : t('order_detail_des')}
      width={1200}
      ...
      {isEditing ? (
        ...
        <ViewForm id={props.id} onCancel={handleCancel} submitIcon={<ArrowRightOutlined />} />
      )}
    </AntModal>
  );
};
