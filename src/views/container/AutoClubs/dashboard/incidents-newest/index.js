...
import IncidentsNewTable from './IncidentsNewTable';
import enhancer, { fetchIncidentsChart, fetchIncidents } from './withEnhance';

function IncidentsNewest(props) {
  ...
  return (
    <React.Fragment>
      <UIDivider title={t('Incident_newest')} />
      <div className="row">
...
export default enhancer(IncidentsNewest);
