...
export const fetchIncidentFixing = (props, sorter, pagination = generatePagination(), filters = {}) => {
  const {
    getMembers,
    dispatchData,
    dispatchFail,
...
export const fetchIncidentFixingChart = (props) => {
  const {
...
export default compose(
  ...
  withHandlers({
    handleTableChange: (props) => (type, newState) => {
      ...
      fetchIncidentFixing(props, sorter, pagination, filtersData);
    }
  })
);
