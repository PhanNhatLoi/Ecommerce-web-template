...
import { columnsCoupon, columnsPackageDiscount } from '../component/Columns';
...
export const ViewFormPromotion = (props: {
  data?: any;
  type?: 'INSURANCE_PACKAGE_DISCOUNT' | 'INSURANCE_COUPON_DISCOUNT';
  onCancel: () => void;
}) => {
  ...
  useEffect(() => {
    switch (props?.data?.promotionType) {
      case INSURANCE_PROMOTION_TYPE.INSURANCE_PACKAGE_DISCOUNT:
        setColumns(columnsPackageDiscount);
        break;
    ...
    <Skeleton loading={loading} active style={{ height: 400 }}>
          ...
          <div>
            ...
            <div className="row mb-5">
              <div className="col-12 col-md-3 col-lg-3">
                <DescriptionItem label={t('description')} layout />
              </div>
              <div className="col-12 col-md-9 col-lg-9 mt-md-5 mt-lg-5 pl-md-1 pl-lg-12 pr-6">
                <MCKEditor
                  noLabel
                  noPadding
                  require={false}
      ...
      <div>
        ...
        <AntTable
          ...
          loading={loading}
          data={
            props?.data?.promotionType === INSURANCE_PROMOTION_TYPE.INSURANCE_PACKAGE_DISCOUNT
              ? props?.data?.insurancePackages
              : props?.data?.promotionType === INSURANCE_PROMOTION_TYPE.INSURANCE_COUPON_DISCOUNT
              ? props?.data?.coupons
              : []
          }
        />
