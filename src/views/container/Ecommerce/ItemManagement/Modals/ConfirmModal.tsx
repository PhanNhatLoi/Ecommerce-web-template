...
const ConfirmModal = (props) => {
  ...
  const onFinish = (values) => {
    switch (actionType) {
      case 'delete':
        confirmAction(values, props.deleteItem);
        break;
      default:
        break;
    }
  ...
  return (
    <AntModal
      title={t(`${actionType}_goods`)}
      description={t(`${actionType}_goods_des`)}
      width={1000}
      ...
      <Form //
        ...
        <ATypography className="mb-3">{t(`${actionType}_goods_helper`)}</ATypography>
        <div className="mb-3">
        ...
        <LableStyled>{t('delete_product_warning')}</LableStyled>
        <MInputStyled //
          noLabel
          noPadding
          label=""
