...
import { ButtonProps as AntButtonProps } from 'antd/es';
...
export function BasicBtn(props: Props) {
  const { t } = useTranslation();
  return (
    <ABtnStyled
      {...props}
      // className="m-2"
      icon={props.icon}
      style={{ margin: '5px', ...props.style, width: props.style?.width || t(props.title || '').length * 10 + 56 }}
