...
import { DropdownCustomToggler, DropdownMenu2 } from '~/views/presentation/_metronic/_partials/dropdowns';
import { useHtmlClassService } from '~/views/presentation/_metronic/layout/_core/MetronicLayout';

export function MixedWidget6({ className, chartColor = 'blue' }) {
