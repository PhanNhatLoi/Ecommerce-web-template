    ...
    <Popconfirm
      ...
      onConfirm={() => {
        ...
        props
          ...
          .catch((err) => {
            console.error(err);
            AMessage.error(t('approve_error'));
            setPopConfirmVisible(false);
            setConfirmLoading(false);
          });
      }}
      ...
      <button title="Approve" className="btn btn-icon btn-light btn-hover-success btn-sm" onClick={() => setPopConfirmVisible(true)}>
