...
export function HeaderMobile() {
  ...
  const layoutProps = useMemo(() => {
    return {
      ...
      headerMenuSelfDisplay: objectPath.get(uiService.config, 'header.menu.self.display') === false,
  ...
  return (
    <>
      ...
      <div
        id="kt_header_mobile"
        className={`d-print-none header-mobile align-items-center ${layoutProps.headerMobileCssClasses}`}
        {...layoutProps.headerMobileAttributes}>
        {/*begin::Logo*/}
        <Link to="/">
          <img alt="logo" style={{ height: 40 }} src={layoutProps.headerLogo} />
        </Link>
        {/*end::Logo*/}
